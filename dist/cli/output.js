import { getVerificationReadiness, getVerificationReasons, } from "../verification/verify.js";
import { getVerdictMessage } from "../verification/proof.js";
import {} from "./cli-options.js";
export function getVerificationExitCode(result) {
...
export function printVerificationResult(result, options) {
    if (options.json) {
