...
export class JestRunner {
    ...
    runJest(cwd, testFiles = []) {
        ...
        try {
            ...
            const hasExecutionError = report.testResults?.some((testResult) => testResult.testExecError !== undefined) ?? false;
